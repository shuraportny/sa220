...
****************************************************************************//**
*
*  Prepares the ModbusUART component to enter Deep Sleep.
...
*    disabling.
*
*  Call the ModbusUART_Sleep() function before calling the 
...
****************************************************************************//**
*
*  Prepares the ModbusUART component for Active mode operation after 
*  Deep Sleep.
...
*
*  \sideeffect
*   Calling the ModbusUART_Wakeup() function without first calling the 
*   ModbusUART_Sleep() function may produce unexpected behavior.
*
*******************************************************************************/
