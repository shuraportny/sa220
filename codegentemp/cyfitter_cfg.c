...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		static const uint8 CYCODE BS_UDB_0_1_1_CONFIG_VAL[] = {
			0x02u, 0x60u, 0x00u, 0x00u, 0x00u, 0x18u, 0x63u, 0x00u, 0x5Cu, 0x00u, 0x23u, 0x66u, 0x00u, 0x10u, 0x00u, 0x00u, 
			0x1Fu, 0x21u, 0x60u, 0x00u, 0x7Fu, 0x08u, 0x00u, 0x00u, 0x73u, 0xFFu, 0x0Cu, 0x00u, 0x01u, 0x19u, 0x00u, 0xE2u, 
			0x08u, 0x40u, 0x00u, 0x00u, 0x04u, 0xE7u, 0x00u, 0x18u, 0x0Cu, 0x19u, 0x00u, 0xE4u, 0x03u, 0x00u, 0x00u, 0x01u, 
			0x2Cu, 0x60u, 0x10u, 0x1Fu, 0x0Fu, 0x00u, 0x4Cu, 0x80u, 0x00u, 0x80u, 0x22u, 0x28u, 0x00u, 0x00u, 0x04u, 0x00u, 
			0x26u, 0x03u, 0x05u, 0x00u, 0x01u, 0x0Cu, 0x00u, 0x0Eu, 0x11u, 0xFFu, 0xFFu, 0xFFu, 0x62u, 0xA0u, 0xF0u, 0x41u, 
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL3), 0x00300000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG4), 0x02000000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG8), 0x04000000u);

		/* INT_SELECT Starting address: CYDEV_CPUSS_INT_SEL */
		CY_SET_REG32((void *)(CYREG_CPUSS_INT_SEL), 0x00000018u);

		/* INT_CONFIG Starting address: CYDEV_UDB_INT_CFG */
		CY_SET_REG32((void *)(CYREG_UDB_INT_CFG), 0x00000018u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00DA4DB0u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x000120C1u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_INTR_CFG), 0x00000F00u);

	/* IOPINS0_2 Starting address: CYDEV_GPIO_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x00000006u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x00181290u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_INTR_CFG), 0x0000003Cu);

	/* IOPINS0_3 Starting address: CYDEV_GPIO_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT3_BASE), 0x00000020u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x00DB1001u);
