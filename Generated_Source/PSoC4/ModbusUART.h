...
#define ModbusUART_COMP_VERSION_MAJOR    (4)
#define ModbusUART_COMP_VERSION_MINOR    (0)
...
#define ModbusUART_REMOVE_UART_RX_WAKEUP_IRQ  (0u)
...
/* Interface to internal interrupt component */
    ...
    */    
    /*******************************************************************************
    * Function Name: ModbusUART_EnableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: ModbusUART_DisableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/    
    ...
    /*******************************************************************************
    * Function Name: ModbusUART_ClearPendingInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: ModbusUART_RxWakeEnableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/    
    ...
    /*******************************************************************************
    * Function Name: ModbusUART_RxWakeDisableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: ModbusUART_RxWakeClearPendingInt
    ****************************************************************************//**
    *
...
/* Get interrupt cause */
/*******************************************************************************
* Function Name: ModbusUART_GetInterruptCause
****************************************************************************//**
*
...
*    - ModbusUART_INTR_CAUSE_MASTER - Interrupt from Master
*    - ModbusUART_INTR_CAUSE_SLAVE - Interrupt from Slave
*    - ModbusUART_INTR_CAUSE_TX - Interrupt from TX
*    - ModbusUART_INTR_CAUSE_RX - Interrupt from RX
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: ModbusUART_GetRxInterruptSource
****************************************************************************//**
*
...
*   - ModbusUART_INTR_RX_FIFO_LEVEL - The number of data elements in the 
      RX FIFO is greater than the value of RX FIFO level.
*   - ModbusUART_INTR_RX_NOT_EMPTY - Receiver FIFO is not empty.
*   - ModbusUART_INTR_RX_FULL - Receiver FIFO is full.
*   - ModbusUART_INTR_RX_OVERFLOW - Attempt to write to a full 
*     receiver FIFO.
*   - ModbusUART_INTR_RX_UNDERFLOW - Attempt to read from an empty 
*     receiver FIFO.
*   - ModbusUART_INTR_RX_FRAME_ERROR - UART framing error detected.
*   - ModbusUART_INTR_RX_PARITY_ERROR - UART parity error detected.
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: ModbusUART_SetRxInterruptMode
****************************************************************************//**
*
...
*   ModbusUART_GetRxInterruptSource() function for bit fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: ModbusUART_GetRxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: ModbusUART_GetRxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: ModbusUART_ClearRxInterruptSource
****************************************************************************//**
*
...
*   - ModbusUART_INTR_RX_FIFO_LEVEL Interrupt source is not cleared when 
*     the receiver FIFO has more entries than level.
*   - ModbusUART_INTR_RX_NOT_EMPTY Interrupt source is not cleared when
*     receiver FIFO is not empty.
*   - ModbusUART_INTR_RX_FULL Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: ModbusUART_SetRxInterrupt
****************************************************************************//**
*
...
*   register (refer to ModbusUART_GetRxInterruptSource() function for bit 
*   fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: ModbusUART_GetTxInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - ModbusUART_INTR_TX_FIFO_LEVEL - The number of data elements in the 
*     TX FIFO is less than the value of TX FIFO level.
*   - ModbusUART_INTR_TX_NOT_FULL - Transmitter FIFO is not full.
*   - ModbusUART_INTR_TX_EMPTY - Transmitter FIFO is empty.
*   - ModbusUART_INTR_TX_OVERFLOW - Attempt to write to a full 
*     transmitter FIFO.
*   - ModbusUART_INTR_TX_UNDERFLOW - Attempt to read from an empty 
*     transmitter FIFO.
*   - ModbusUART_INTR_TX_UART_NACK - UART received a NACK in SmartCard 
*   mode.
*   - ModbusUART_INTR_TX_UART_DONE - UART transfer is complete. 
*     All data elements from the TX FIFO are sent.
*   - ModbusUART_INTR_TX_UART_ARB_LOST - Value on the TX line of the UART
...
/*******************************************************************************
* Function Name: ModbusUART_SetTxInterruptMode
****************************************************************************//**
*
...
*   ModbusUART_GetTxInterruptSource() function for bit field values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: ModbusUART_GetTxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: ModbusUART_GetTxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: ModbusUART_ClearTxInterruptSource
****************************************************************************//**
*
...
*   - ModbusUART_INTR_TX_FIFO_LEVEL - Interrupt source is not cleared when 
*     transmitter FIFO has less entries than level.
*   - ModbusUART_INTR_TX_NOT_FULL - Interrupt source is not cleared when
*     transmitter FIFO has empty entries.
*   - ModbusUART_INTR_TX_EMPTY - Interrupt source is not cleared when 
*     transmitter FIFO is empty.
*   - ModbusUART_INTR_TX_UNDERFLOW - Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: ModbusUART_SetTxInterrupt
****************************************************************************//**
*
*  Sets RX interrupt sources in the interrupt request register.
*
...
/*******************************************************************************
* Function Name: ModbusUART_GetMasterInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - ModbusUART_INTR_MASTER_SPI_DONE - SPI master transfer is complete.
*     Refer to Interrupt sources section for detailed description.
*   - ModbusUART_INTR_MASTER_I2C_ARB_LOST - I2C master lost arbitration.
*   - ModbusUART_INTR_MASTER_I2C_NACK - I2C master received negative 
*    acknowledgement (NAK).
*   - ModbusUART_INTR_MASTER_I2C_ACK - I2C master received acknowledgement.
*   - ModbusUART_INTR_MASTER_I2C_STOP - I2C master generated STOP.
*   - ModbusUART_INTR_MASTER_I2C_BUS_ERROR - I2C master bus error 
...
/*******************************************************************************
* Function Name: ModbusUART_SetMasterInterruptMode
****************************************************************************//**
*
...
*   ModbusUART_GetMasterInterruptSource() function for bit field values).
*
*******************************************************************************/
#define ModbusUART_SetMasterInterruptMode(interruptMask)  ModbusUART_WRITE_INTR_MASTER_MASK(interruptMask)

/*******************************************************************************
* Function Name: ModbusUART_GetMasterInterruptMode
****************************************************************************//**
*
...
*   ModbusUART_GetMasterInterruptSource() function for return values).
*
*******************************************************************************/
#define ModbusUART_GetMasterInterruptMode()   (ModbusUART_INTR_MASTER_MASK_REG)

/*******************************************************************************
* Function Name: ModbusUART_GetMasterInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: ModbusUART_ClearMasterInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: ModbusUART_SetMasterInterrupt
****************************************************************************//**
*
*  Sets Master interrupt sources in the interrupt request register.
*
*  \param interruptMask: Master interrupt sources to set in the Master interrupt
*   request register (refer to ModbusUART_GetMasterInterruptSource() 
...
/*******************************************************************************
* Function Name: ModbusUART_GetSlaveInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - ModbusUART_INTR_SLAVE_I2C_ARB_LOST - I2C slave lost arbitration: 
*     the value driven on the SDA line is not the same as the value observed 
*     on the SDA line.
*   - ModbusUART_INTR_SLAVE_I2C_NACK - I2C slave received negative 
*     acknowledgement (NAK).
*   - ModbusUART_INTR_SLAVE_I2C_ACK - I2C slave received 
*     acknowledgement (ACK).
*   - ModbusUART_INTR_SLAVE_I2C_WRITE_STOP - Stop or Repeated Start 
*     event for write transfer intended for this slave (address matching 
*     is performed).
*   - ModbusUART_INTR_SLAVE_I2C_STOP - Stop or Repeated Start event 
*     for (read or write) transfer intended for this slave (address matching 
*     is performed).
*   - ModbusUART_INTR_SLAVE_I2C_START - I2C slave received Start 
*     condition.
*   - ModbusUART_INTR_SLAVE_I2C_ADDR_MATCH - I2C slave received matching 
*     address.
*   - ModbusUART_INTR_SLAVE_I2C_GENERAL - I2C Slave received general 
*     call address.
*   - ModbusUART_INTR_SLAVE_I2C_BUS_ERROR - I2C slave bus error (detection 
*      of unexpected Start or Stop condition).
*   - ModbusUART_INTR_SLAVE_SPI_BUS_ERROR - SPI slave select line is 
...
/*******************************************************************************
* Function Name: ModbusUART_SetSlaveInterruptMode
****************************************************************************//**
*
...
*   ModbusUART_GetSlaveInterruptSource() function for bit field values).
*
*******************************************************************************/
#define ModbusUART_SetSlaveInterruptMode(interruptMask)   ModbusUART_WRITE_INTR_SLAVE_MASK(interruptMask)

/*******************************************************************************
* Function Name: ModbusUART_GetSlaveInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: ModbusUART_GetSlaveInterruptSourceMasked
****************************************************************************//**
*
...
*   ModbusUART_GetSlaveInterruptSource() function for return values).
*
*******************************************************************************/
#define ModbusUART_GetSlaveInterruptSourceMasked()    (ModbusUART_INTR_SLAVE_MASKED_REG)

/*******************************************************************************
* Function Name: ModbusUART_ClearSlaveInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: ModbusUART_SetSlaveInterrupt
****************************************************************************//**
*
*  Sets Slave interrupt sources in the interrupt request register.
*
*  \param interruptMask: Slave interrupt sources to set in the Slave interrupt 
*   request register (refer to ModbusUART_GetSlaveInterruptSource() 
...
#define ModbusUART_STATUS_PTR             ( (reg32 *) ModbusUART_SCB__STATUS)
    ...
    #define ModbusUART_UART_TX_CTRL_PTR       ( (reg32 *) ModbusUART_SCB__UART_TX_CTRL)
...
#ifdef ModbusUART_SCB__EZ_DATA0
    #define ModbusUART_EZBUF_DATA0_REG    (*(reg32 *) ModbusUART_SCB__EZ_DATA0)
    #define ModbusUART_EZBUF_DATA0_PTR    ( (reg32 *) ModbusUART_SCB__EZ_DATA0)
#else
    #define ModbusUART_EZBUF_DATA0_REG    (*(reg32 *) ModbusUART_SCB__EZ_DATA00)
    #define ModbusUART_EZBUF_DATA0_PTR    ( (reg32 *) ModbusUART_SCB__EZ_DATA00)
#endif /* ModbusUART_SCB__EZ_DATA00 */
...
#define ModbusUART_FIFO_SIZE      (8u)  /* TX or RX FIFO size. */
#define ModbusUART_EZ_DATA_NR     (32u)  /* Number of words in EZ memory. */ 
#define ModbusUART_ONE_BYTE_WIDTH (8u)            /* Number of bits in one byte. */
#define ModbusUART_FF_DATA_NR_LOG2_MASK       (0x0Fu)      /* Number of bits to represent a FIFO address. */
#define ModbusUART_FF_DATA_NR_LOG2_PLUS1_MASK (0x1Fu) /* Number of bits to represent #bytes in FIFO. */
...
#define ModbusUART_SPI_CTRL_LATE_MISO_SAMPLE      ((uint32) 0x01u << \
    ...
    #define ModbusUART_SPI_CTRL_SSEL0_POLARITY   ((uint32) 0x01u << ModbusUART_SPI_CTRL_SSEL0_POLARITY_POS)
    #define ModbusUART_SPI_CTRL_SSEL1_POLARITY   ((uint32) 0x01u << ModbusUART_SPI_CTRL_SSEL1_POLARITY_POS)
    #define ModbusUART_SPI_CTRL_SSEL2_POLARITY   ((uint32) 0x01u << ModbusUART_SPI_CTRL_SSEL2_POLARITY_POS)
    #define ModbusUART_SPI_CTRL_SSEL3_POLARITY   ((uint32) 0x01u << ModbusUART_SPI_CTRL_SSEL3_POLARITY_POS)
...
*/
#define ModbusUART_SCB_SW_RESET   ModbusUART_I2CFwBlockReset()
...
#define ModbusUART_DISABLE_AUTO_DATA \
                do{                        \
                    ModbusUART_I2C_CTRL_REG &= ((uint32) ~(ModbusUART_I2C_CTRL_M_READY_DATA_ACK      |  \
                                                                 ModbusUART_I2C_CTRL_M_NOT_READY_DATA_NACK |  \
                                                                 ModbusUART_I2C_CTRL_S_READY_DATA_ACK      |  \
                                                                 ModbusUART_I2C_CTRL_S_NOT_READY_DATA_NACK)); \
                }while(0)
...
#define ModbusUART_GET_I2C_CTRL_S_GENERAL_IGNORE(genCall) ((0u != (genCall)) ? \
                                                                    (ModbusUART_I2C_CTRL_S_GENERAL_IGNORE) : (0u))
...
#define ModbusUART_GET_UART_RX_CTRL_BREAK_WIDTH(width)    (((uint32) ((uint32) (width) - 1u) << \
                                                                    ModbusUART_UART_RX_CTRL_BREAK_WIDTH_POS) & \
                                                                    ModbusUART_UART_RX_CTRL_BREAK_WIDTH_MASK)
...
#define ModbusUART_GET_TX_CTRL_DATA_WIDTH(dataWidth)  (((uint32) (dataWidth) - 1u) & \
                                                                ModbusUART_TX_CTRL_DATA_WIDTH_MASK)
...
/* ModbusUART_INTR_SLAVE_I2C_GENERAL */
#define ModbusUART_GET_INTR_SLAVE_I2C_GENERAL(genCall)  ((0u != (genCall)) ? \
                                                                (ModbusUART_INTR_SLAVE_I2C_GENERAL) : (0u))

/* Return true if master mode is enabled ModbusUART_SPI_CTRL_REG */
#define ModbusUART_CHECK_SPI_MASTER   (0u != (ModbusUART_SPI_CTRL_REG & ModbusUART_SPI_CTRL_MASTER))

/* Return inactive state of SPI SCLK line depends on CPOL */
#define ModbusUART_GET_SPI_SCLK_INACTIVE \
            ((0u == (ModbusUART_SPI_CTRL_REG & ModbusUART_SPI_CTRL_CPOL)) ? (0u) : (1u))

/* Get output pin inactive state */
#if (ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1)
#define ModbusUART_GET_SPI_SS0_INACTIVE       (1u)
#define ModbusUART_GET_SPI_SS1_INACTIVE       (1u)
#define ModbusUART_GET_SPI_SS2_INACTIVE       (1u)
#define ModbusUART_GET_SPI_SS3_INACTIVE       (1u)
#define ModbusUART_GET_UART_RTS_INACTIVE      (1u)

#else
#define ModbusUART_GET_SPI_SS0_INACTIVE  \
        ((0u != (ModbusUART_SPI_CTRL_REG & ModbusUART_SPI_CTRL_SSEL0_POLARITY)) ? (0u) : (1u))

#define ModbusUART_GET_SPI_SS1_INACTIVE  \
        ((0u != (ModbusUART_SPI_CTRL_REG & ModbusUART_SPI_CTRL_SSEL1_POLARITY)) ? (0u) : (1u))

#define ModbusUART_GET_SPI_SS2_INACTIVE  \
        ((0u != (ModbusUART_SPI_CTRL_REG & ModbusUART_SPI_CTRL_SSEL2_POLARITY)) ? (0u) : (1u))

#define ModbusUART_GET_SPI_SS3_INACTIVE  \
        ((0u != (ModbusUART_SPI_CTRL_REG & ModbusUART_SPI_CTRL_SSEL3_POLARITY)) ? (0u) : (1u))

#define ModbusUART_GET_UART_RTS_INACTIVE \
        ((0u == (ModbusUART_UART_FLOW_CTRL_REG & ModbusUART_UART_FLOW_CTRL_RTS_POLARITY)) ? (0u) : (1u))
...
#define ModbusUART_EZBUFFER_SIZE          (ModbusUART_EZ_DATA_NR)

#define ModbusUART_EZBUF_DATA00_REG   ModbusUART_EZBUF_DATA0_REG
#define ModbusUART_EZBUF_DATA00_PTR   ModbusUART_EZBUF_DATA0_PTR
