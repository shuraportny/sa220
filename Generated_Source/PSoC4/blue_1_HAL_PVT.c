...
void CyBLE_Uart_Start (void)
{
        ...
        /* Setup ISR */
        blue_1_uart_isr_StartEx(&CyBLE_Uart_Interrupt);

        blue_1_HAL_Uart_Start();
...
void CyBLE_Uart_Stop (void)
{
        ...
        blue_1_uart_isr_Stop();

        blue_1_HAL_Uart_Stop();
    #endif /* (CYBLE_HCI_TYPE == CYBLE_HCI_OVER_UART) */
}
...
{
    #if (CYBLE_HCI_TYPE == CYBLE_HCI_OVER_UART)
        blue_1_HAL_Uart_SpiUartPutArray(dataBuf, (uint32)length);
    #endif /* (CYBLE_HCI_TYPE == CYBLE_HCI_OVER_UART) */
}
...
/* Interface to blue_1_bless_isr_Enable function */
void CyBleHal_EnableGlobalInterrupts(void)
{
    blue_1_bless_isr_Enable();
}

/* Interface to blue_1_bless_isr_Disable function */
...
void CyBle_HalInit(void)
{
    ...
    blue_1_bless_isr_SetVector(&CyBLE_Bless_Interrupt);
...
void CYBLE_BlessStart(void)
{
    ...
    blue_1_bless_isr_StartEx(&CyBLE_Bless_Interrupt);
}
