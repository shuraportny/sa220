...
void MessageTimer_Enable(void)
{
    ...
    #if (MessageTimer__QUAD == MessageTimer_CONFIG)
        #if (0u != MessageTimer_QUAD_AUTO_START)
            MessageTimer_TriggerCommand(MessageTimer_MASK, MessageTimer_CMD_RELOAD);
        #endif /* (0u != MessageTimer_QUAD_AUTO_START) */
    #endif  /* (MessageTimer__QUAD == MessageTimer_CONFIG) */
}
...
*   Values:
*     - MessageTimer_CMD_CAPTURE    - Trigger Capture/Switch command
*     - MessageTimer_CMD_RELOAD     - Trigger Reload/Index command
*     - MessageTimer_CMD_STOP       - Trigger Stop/Kill command
*     - MessageTimer_CMD_START      - Trigger Start/phiB command
*
* Return:
*  None
*
